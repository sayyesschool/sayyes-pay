  ...
  try {
    ...
    for (const storageKey of keys) {
      ...
      list.push({
        ...
        reviveStep: b.reviveStep || 0,
        reviveStartAt: b.reviveStartAt || null,
        reviveSentAt: b.reviveSentAt || null,
        reviveStopped: Boolean(b.reviveStopped),
        reviveStopReason: b.reviveStopReason || null,
        paid: Boolean(b.paid),
